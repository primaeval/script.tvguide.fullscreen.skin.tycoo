...
if skin > -1:
    ...
    if tvgf:
        ...
        tvgf.setSetting('program.background.texture.url', 'special://home/addons/script.tvguide.fullscreen.skin.tycoo/resources/skins/WhiteSnowCustomFont/media/wallpaper_grey.jpg')
